...
const projects: Project[] = [
  ...
  {
    tag: "Projet entreprise · Renault — Alternance (en cours)",
    title: "Sonde de température — Presse",
    desc: "Ajout d'une sonde PT100 sur la poulie moteur d'une presse d'emboutissage, modification IHM WIN CC et programme automate Siemens. Projet en cours, blocage en phase finale.",
    icon: "🌡️",
    bg: "linear-gradient(135deg, #1a1800 0%, #2a2600 100%)",
    highlights: ["Presse Renault", "Carte analogique", "WIN CC", "Siemens", "En cours"],
    color: "#f0c040",
    context: "Face à des surchauffes répétées sur la poulie du moteur principal d'une presse d'emboutissage à l'usine Georges Besse de Renault, mission d'instrumenter ce point critique avec une sonde de température PT100. Mission menée en quasi-autonomie sur la ligne 21, via créneaux de maintenance autonome (la maquette Siemens disponible étant incompatible avec le programme cible).",
    objectifs: ["Installer une sonde PT100 sur la poulie moteur (câblage 3 fils)", "Intégrer une carte analogique dans l'armoire", "Modifier le programme automate Siemens (Step 7 sous SIMATIC Manager)", "Mettre à jour l'IHM WIN CC (affichage temps réel + alarmes)"],
    technologies: ["Sonde PT100", "Carte analogique", "Step 7 — SIMATIC Manager", "WIN CC (IHM)", "Câblage industriel"],
    resultats: "Sonde installée, programme et IHM développés directement sur la ligne. Tests instrumentés satisfaisants : 48°C en fonctionnement nominal, mesure stable observée sur une semaine. Blocage en phase finale identifié et caractérisé avec le GATM : le programme passe en STOP au retrait du bit de neutralisation. Hypothèse retenue : le bloc CTEMP de la sonde est positionné hors de la séquence homogène des CTEMP existants. Restructuration à venir avant la mise en service définitive.",
    ...
    lecons: "Avancer en autonomie sur une ligne en production exige un dialogue régulier avec les équipes ressources (ici le GATM) dès qu'un comportement inattendu apparaît, plutôt que d'essayer de tout résoudre seul.",
    screenshots: [
